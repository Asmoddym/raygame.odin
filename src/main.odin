...
main :: proc() {
  ...
  engine.system_register(engine.SystemType.RUNTIME,  drawable_system_update_camera_position)
  engine.system_register(engine.SystemType.RUNTIME,  drawable_system_animated_sprite_update)
  ...
  engine.system_register(engine.SystemType.RUNTIME,  drawable_system_text_box_update)
  engine.system_register(engine.SystemType.RUNTIME,  bounding_box_system_collision_resolver)
  engine.system_register(engine.SystemType.RUNTIME,  drawable_system_draw)
  engine.system_register(engine.SystemType.RUNTIME,  drawable_system_text_box_draw)
