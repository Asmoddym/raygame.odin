...
clay_sys :: proc() {
        ...
        windowWidth = i32(raylib.GetScreenToWorld2D({ f32(engine.game_state.resolution.x), f32(engine.game_state.resolution.y) }, engine.camera).x)
        windowHeight = i32(raylib.GetScreenToWorld2D({ f32(engine.game_state.resolution.x), f32(engine.game_state.resolution.y) }, engine.camera).y)
        windowHeight = engine.game_state.resolution.y
...
main :: proc() {
  ...
  engine.init()
    ...
    loadFont(FONT_ID_TITLE_56, 56, "Calistoga-Regular.ttf")
    loadFont(FONT_ID_TITLE_52, 52, "Calistoga-Regular.ttf")
    loadFont(FONT_ID_TITLE_48, 48, "Calistoga-Regular.ttf")
    loadFont(FONT_ID_TITLE_36, 36, "Calistoga-Regular.ttf")
    loadFont(FONT_ID_TITLE_32, 32, "Calistoga-Regular.ttf")
    loadFont(FONT_ID_BODY_36, 36, "Quicksand-Semibold.ttf")
    loadFont(FONT_ID_BODY_30, 30, "Quicksand-Semibold.ttf")
    loadFont(FONT_ID_BODY_28, 28, "Quicksand-Semibold.ttf")
    loadFont(FONT_ID_BODY_24, 24, "Quicksand-Semibold.ttf")
    loadFont(FONT_ID_BODY_16, 16, "Quicksand-Semibold.ttf")

    syntaxImage = raylib.LoadTexture("declarative.png")
    checkImage1 = raylib.LoadTexture("check_1.png")
    checkImage2 = raylib.LoadTexture("check_2.png")
    checkImage3 = raylib.LoadTexture("check_3.png")
    checkImage4 = raylib.LoadTexture("check_4.png")
    checkImage5 = raylib.LoadTexture("check_5.png")
  ...
  engine.system_register(clay_sys)
