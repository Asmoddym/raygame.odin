...
input_system_main :: proc() {
  ...
  if rl.IsKeyDown(rl.KeyboardKey.LEFT)  do engine.camera.target.x -= 800 * time
  if rl.IsKeyDown(rl.KeyboardKey.RIGHT) do engine.camera.target.x += 800 * time
  if rl.IsKeyDown(rl.KeyboardKey.UP)    do engine.camera.target.y -= 800 * time
  if rl.IsKeyDown(rl.KeyboardKey.DOWN)  do engine.camera.target.y += 800 * time
